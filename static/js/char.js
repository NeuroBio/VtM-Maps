...
havens = [
    ...
    makeChar('Gree', [33.363814263278435, -112.03995605332327], 'A perpetually-under-construction frame of what theoretically could be a mansion.  Gree’s dream house project is unlikely to ever be finished, because he keep changes his mind about what the perfect house looks like.  Provides next to no security outside of itsdistance from the city center, because none of the walls or rooms are finished.'),
    makeChar('Kyle', [33.44278671837701, -112.08561744978024], 'To escape the electricity of the upper world, Kyle joined the Nosferatu in the sewers.  Since they left for Hartstone, their city of reclaimed goods, stolen items, and outright trash is entirely in Kyle’s care now.')
];